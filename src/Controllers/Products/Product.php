...
throw new \Exception("Formulario en modo inválido");
...
$errors["productName_error"]="Nombre requerido";
}

if(Validators::IsEmpty($this->product["productDescription"])){
$errors["productDescription_error"]="Descripción requerida";
}

if($this->product["productPrice"]<=0){
$errors["productPrice_error"]="Precio inválido";
}

if(Validators::IsEmpty($this->product["productImgUrl"])){
$errors["productImgUrl_error"]="Imagen requerida";
}
